!function() {
    ...
    !function(n) {
        ...
        function o(e, t) {
            var i, n, r, o, a, l, s, d, c, f, u, h = t && t.split("/"), g = y.map, m = g && g["*"] || {};
            if (e && "." === e.charAt(0))
                if (t) {
                    for (e = e.split("/"),
                    a = e.length - 1,
                    y.nodeIdCompat && _.test(e[a]) && (e[a] = e[a].replace(_, "")),
        ...
        var u, h, g, m, p = {}, v = {}, y = {}, R = {}, b = Object.prototype.hasOwnProperty, w = [].slice, _ = /\.js$/;
        g = function(e, t) {
            var i, n = c(e), r = n[0];
            return e = n[1],
            r && (r = o(r, t),
            i = d(r)),
            r ? e = i && i.normalize ? i.normalize(e, l(t)) : o(e, t) : (e = o(e, t),
            n = c(e),
            r = n[0],
            e = n[1],
            r && (i = d(r))),
            ...
            "undefined" === w || "function" === w) {
                ...
                h = 0; h < t.length; h += 1)
                    ...
                    "require" === (c = u.f))
                        ...
                        l = b[h] = m.module(e);
                    else if (r(p, c) || r(v, c) || r(R, c))
                        b[h] = d(c);
                    else {
                        if (!u.p)
                            throw new Error(e + " missing " + c);
                        u.p.load(u.n, a(o, !0), s(c), {}),
                        b[h] = p[c]
                    }
                f = i ? i.apply(p[e], b) : void 0,
                e && (l && l.exports !== n && l.exports !== p[e] ? p[e] = l.exports : f === n && y || (p[e] = f))
            } else
                e && (p[e] = i)
        }
        ,
        e = t = h = function(e, t, i, r, o) {
            ...
            r = o),
            r ? u(n, e, t, i) : setTimeout(function() {
                u(n, e, t, i)
            }, 4),
            h
        }
    ...
    i("models/fieldModel", ["models/fieldErrorCollection"], function(e) {
        return Backbone.Model.extend({
            ...
            initialize: function() {
                ...
                "undefined" != this.get("parentType") && nfRadio.channel(this.get("parentType")).trigger("init:model", this),
    ...
    i("controllers/changeField", [], function() {
        return Marionette.Object.extend({
            ...
            changeField: function(e, t) {
                ...
                i = void 0 !== i ? i : nfRadio.channel(t.get("parentType")).request("before:updateField", e, t),
                i = void 0 !== i ? i : jQuery(e).val(),
                t.set("isUpdated", !1),
                t.set("clean", !1),
        ...
        return Marionette.Object.extend({
            ...
            dateChange: function(e) {
                var i = e.get("id")
                  , n = e.get("value")
                  , r = e.get("date_format");
                if ("default" === r && (r = nfi18n.dateFormat),
                0 < n.length)
            ...
            dateKeyup: function(e, i, n) {
                ...
                var r = jQuery(e).val()
                  , o = i.get("id")
                  , a = i.get("date_format");
                if ("default" === a && (a = nfi18n.dateFormat),
                0 == r.length)
                    nfRadio.channel("fields").request("remove:error", o, t);
                else if (moment(r, a).isValid() || i.get("clean"))
                    moment(r, a).isValid() && (nfRadio.channel("fields").request("remove:error", o, t),
                    i.addWrapperClass("nf-pass"),
                    i.set("clean", !1));
                else {
                    var l = nfRadio.channel("fields").request("get:field", o)
                      , s = nfRadio.channel("app").request("get:form", l.get("formID"));
                    nfRadio.channel("fields").request("add:error", o, t, s.get("settings").changeDateErrorMsg),
        ...
        return Marionette.Object.extend({
            ...
            renderOptions: function() {
                ...
                if (_.each(this.options, function(i, n) {
                    Array.isArray(this.value) && (Array.isArray(this.value[0]) && -1 !== _.indexOf(this.value[0], i.value) ? t = !0 : _.indexOf(this.value, i.value) && (t = !0)),
        ...
        return Marionette.Object.extend({
            ...
            renderOptions: function() {
                ...
                if (_.each(this.options, function(i, n) {
                    ...
                    i.index = n,
                    i.required = this.required,
                    this.clean && 1 == this.selected ? i.selected = !0 : this.value == i.value ? i.selected = !0 : i.selected = !1;
        ...
        return Marionette.Object.extend({
            ...
            confirmKeyup: function(e, i, n) {
                ...
                if (i.get("confirm_field"))
                    ...
                    var o = nfRadio.channel("fields").request("get:field", i.get("confirm_with"))
                      , a = o.get("id")
                      , d = o.get("value")
                      , s = d;
                if (void 0 !== o)
    ...
    i("controllers/submitButton", ["controllers/submitButton"], function(e) {
        return Marionette.Object.extend({
            ...
            resetLabel: function(e) {
                void 0 !== this.get("oldLabel") && this.set("label", this.get("oldLabel")),
                this.set("disabled", !1),
                this.trigger("reRender")
            }
        })
        ...
        return Marionette.Object.extend({
            ...
            getFormErrors: function(e) {
                ...
                return t && (0 !== t.get("errors").length && _.each(t.get("errors").models, function(e) {
                    i = i || {},
                    i[e.get("id")] = e.get("msg")
                }),
                _.each(t.get("fields").models, function(e) {
                    "submit" != e.get("type") && e.get("errors").length > 0 && (i = i || {},
                    i[e.get("id")] = e.get("errors"))
                })),
                i
            }
        })
        ...
        return Marionette.Object.extend({
            ...
            submitErrors: function(e, t, i, n) {
                ...
                void 0 !== e.errors.last && void 0 !== e.errors.last.message) {
                    ...
                    console.log("%c NINJA FORMS SUPPORT: SERVER ERROR", r),
                    console.log(e.errors.last.message),
                    console.log("%c END SERVER ERROR MESSAGE", r)
                }
            ...
            register: function(e) {
                ...
                0 != e.get("options").length) {
                    ...
                    if ("listmultiselect" == e.get("type")) {
                        ...
                        if (void 0 === i && (i = _.first(e.get("options"))),
    ...
    i("controllers/calculations", ["models/calcCollection"], function(e) {
        return Marionette.Object.extend({
            ...
            getCalcValue: function(e) {
                ...
                return void 0 === t && (t = jQuery.isNumeric(e.get("value")) ? e.get("value") : 0),
                e.get("visible") || (t = 0),
                jQuery.isNumeric(t) ? t : 0
            },
                ...
                void 0 !== this.displayFields[e.get("name")] && _.each(this.displayFields[e.get("name")], function(i) {
                    ...
                    _.each(o, function(e) {
                        var r = e.replace("}", "").replace("{calc:", "").replace(":2", "")
                          ...
                          , a = new RegExp(e,"g")
                          , l = o.get("value");
                        void 0 !== l && (l = t.applyLocaleFormatting(l)),
    ...
    i("controllers/fieldDate", [], function() {
        return Marionette.Object.extend({
            ...
            initDatepicker: function(e) {
                ...
                1 == e.model.get("date_default") && n.setDate(moment()),
                nfRadio.channel("pikaday").trigger("init", n, e.model)
            },
            getYearRange: function(e) {
                var t = e.get("year_range_start")
                  , i = e.get("year_range_end");
                return t && i ? [t, i] : t ? (i = t + 10,
                [t, i]) : i ? (t = i - 10,
                [t, i]) : 10
            },
        ...
        return Marionette.Object.extend({
            ...
            initTextareaRTEs: function(e) {
                ...
                var t = this
                  ...
                  , r = [["paragraphStyle", ["style"]], ["fontStyle", ["bold", "italic", "underline", "clear"]], ["lists", ["ul", "ol"]], ["paragraph", ["paragraph"]], ["customGroup", ["linkButton", "unlink"]], ["table", ["table"]], ["actions", ["undo", "redo"]]];
                1 == e.model.get("textarea_media") && 0 != userSettings.uid && r.push(["tools", ["mediaButton"]]),
            ...
            openMediaManager: function(e, t) {
                ...
                this.meta_image_frame)
                    return void this.meta_image_frame.open();
                ...
                return {
                    ...
                    renderDescText: function() {
                        if (void 0 === this.desc_text)
                            return "";
                        var e = document.createElement("p");
                        if (e.innerHTML = this.desc_text,
                        0 == jQuery.trim(e.innerText).length)
                            return "";
                        var t, i;
                        if (i = document.createTextNode(this.desc_text),
                        t = document.createElement("p"),
                        t.appendChild(i),
                        0 != jQuery.trim(jQuery(t).text()).length) {
                            var n, r;
                            return n = document.createRange().createContextualFragment(this.desc_text),
                            r = document.createElement("div"),
                            r.classList.add("nf-field-description"),
                            r.appendChild(n),
                            r.outerHTML
                        }
                        return ""
        ...
        return Marionette.ItemView.extend({
            ...
            updateCount: function(e, t) {
                ...
                if ("characters" == this.model.get("input_limit_type") || "char" == this.model.get("input_limit_type"))
                    ...
                    this.count = this.model.get("input_limit") - a;
                else {
    ...
    i("controllers/defaultFilters", ["views/fieldCollection", "models/fieldCollection"], function(e, t) {
        return Marionette.Object.extend({
            ...
            defaultFormContentLoad: function(e, i, n) {
                ...
                if (1 == _.without(o, void 0).length || void 0 === e || 1 == e instanceof Backbone.Collection)
                    return i.get("fields");
    ...
    jQuery(document).ready(function(e) {
        t(["models/formCollection", "models/formModel", "models/fieldCollection", "controllers/loadControllers", "views/mainLayout"], function(t, i, n, r, o) {
            if ("undefined" == typeof nfForms)
                return void jQuery(".nf-form-cont").empty();
                    ...
                    jQuery.ajax({
                        ...
                        success: function(e, t, i) {
                            try {
                                e = JSON.parse(e);
                                var n = e.data;
                                nfFrontEnd.ajaxNonce = n.new_nonce,
                                nfFrontEnd.nonce_ts = n.nonce_ts
                            } catch (e) {
                                console.log("Parse Error")
                            }
                        },
